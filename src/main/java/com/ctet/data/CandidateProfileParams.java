...
public class CandidateProfileParams extends Base {
	...
	public String getQualifier5() {
		return (qualifier5 == null || qualifier5.length() == 0) ? "NA" : this.qualifier5;
	}
	...
	@Override
	public int hashCode() {
		String all = (getQualifier1() != null ? getQualifier1() : "NA") + (getQualifier2() != null ? getQualifier2() : "NA")
				+ (getQualifier3() != null ? getQualifier3() : "NA") + (getQualifier4() != null ? getQualifier4() : "NA")
				+ (getQualifier5() != null ? getQualifier5() : "NA");
		return all.hashCode();
	}
