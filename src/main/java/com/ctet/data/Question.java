...
public class Question extends Base {
	...
	// @OneToMany(targetEntity=Options.class, mappedBy="Question",
...
//@ExcelCell(10)   
	...
	private String getHrefLevel4() {
		...
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQualifier1And2And3And4?qualifier1=" + getQualifier1() + "&qualifier2=" + getQualifier2() + "&qualifier3=" + getQualifier3()
				+ "&qualifier4=" + getQualifier4();
		url = url.replace("$url$", meth);
	...
	private String getHrefLevel5() {
		// searchQByQualifier1And2And3
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQualifier1And2And3And4And5?qualifier1=" + getQualifier1() + "&qualifier2=" + getQualifier2() + "&qualifier3=" + getQualifier3()
				+ "&qualifier4=" + getQualifier4() + "&qualifier5=" + getQualifier5();
		url = url.replace("$url$", meth);
	...
	private String getTestHrefLevel4() {
		// searchQByQualifier1And2And3
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQ1And2And3And4?qualifier1=" + getQualifier1() + "&qualifier2=" + getQualifier2() + "&qualifier3=" + getQualifier3() + "&qualifier4="
				+ getQualifier4();
		url = url.replace("$url$", meth);
		url = url.replace("$cat$", getQualifier4());
		return url;
	...
	private String getTestHrefLevel5() {
		// searchQByQualifier1And2And3
		String url = "<a href=\"$url$\">$cat$</a>";
		String meth = "searchQByQ1And2And3And4And5?qualifier1=" + getQualifier1() + "&qualifier2=" + getQualifier2() + "&qualifier3=" + getQualifier3() + "&qualifier4="
				+ getQualifier4() + "&qualifier5=" + getQualifier5();
		url = url.replace("$url$", meth);
		url = url.replace("$cat$", getQualifier5());
		return url;
	}
		...
		if (getQualifier1() != null && getQualifier1().trim().length() != 0) {
			if (getQualifier2() != null && getQualifier2().trim().length() != 0) {
				if (getQualifier3() != null && getQualifier3().trim().length() != 0) {
					if (getQualifier4() != null && getQualifier4().trim().length() != 0) {
						if (getQualifier5() != null && getQualifier5().trim().length() != 0) {
							url += "addQuestionsByCategoryToSectionAjax?qualifier1=" + URLEncoder.encode(qualifier1) + "&qualifier2="
									+ URLEncoder.encode(qualifier2) + "&qualifier3=" + URLEncoder.encode(qualifier3) + "&qualifier4="
									+ URLEncoder.encode(qualifier4) + "&qualifier5=" + URLEncoder.encode(qualifier5);
							url += "\">Add All</a>";
							return url;
						} else {
							url += "addQuestionsByCategoryToSectionAjax?qualifier1=" + URLEncoder.encode(qualifier1) + "&qualifier2="
									+ URLEncoder.encode(qualifier2) + "&qualifier3=" + URLEncoder.encode(qualifier3) + "&qualifier4="
									+ URLEncoder.encode(qualifier4);
							url += "\">Add All</a>";
							return url;
						}
					} else {
						url += "addQuestionsByCategoryToSectionAjax?qualifier1=" + URLEncoder.encode(qualifier1) + "&qualifier2="
								+ URLEncoder.encode(qualifier2) + "&qualifier3=" + URLEncoder.encode(qualifier3);
						url += "\">Add All</a>";
						return url;
					}
				} else {
		...
		if (getQualifier1() != null && getQualifier1().trim().length() != 0) {
			if (getQualifier2() != null && getQualifier2().trim().length() != 0) {
				if (getQualifier3() != null && getQualifier3().trim().length() != 0) {
					if (getQualifier4() != null && getQualifier4().trim().length() != 0) {
						if (getQualifier5() != null && getQualifier5().trim().length() != 0) {
							url += "removeQuestionsByCategoryToSectionAjax?qualifier1=" + URLEncoder.encode(qualifier1) + "&qualifier2="
									+ URLEncoder.encode(qualifier2) + "&qualifier3=" + URLEncoder.encode(qualifier3) + "&qualifier4="
									+ URLEncoder.encode(qualifier4) + "&qualifier5=" + URLEncoder.encode(qualifier5);
							url += "\">Remove All</a>";
							return url;
